    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto md:mx-0 pb-12 sm:pb-16">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 sm:gap-6 mb-8 sm:mb-10">
          <div>
            <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-purple-100 dark:bg-purple-900/40 px-3.5 py-1 sm:px-4 sm:py-1.5 text-purple-800 dark:text-purple-200 font-bold text-xs sm:text-sm mb-3 sm:mb-4 border border-purple-200 dark:border-purple-700"><Users className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> Learn together</div>
            <h1 className="text-3xl sm:text-5xl font-['Kalam',cursive] font-bold text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2 flex items-center gap-2.5 sm:gap-4 leading-tight"><LibraryBig className="w-8 h-8 sm:w-10 sm:h-10 text-purple-500 shrink-0" /> Course Library</h1>
            <p className="text-gray-600 dark:text-gray-400 font-bold text-sm sm:text-lg">Discover courses shared by learners, then make them your own.</p>
          </div>
          <button onClick={() => setShowUpload(true)} className="w-full sm:w-auto bg-purple-500 hover:bg-purple-600 text-white font-bold py-2.5 sm:py-3 px-5 sm:px-6 rounded-xl border-2 border-purple-700 shadow-[0_4px_0_#6b21a8] sm:shadow-[0_5px_0_#6b21a8] hover:translate-y-0.5 hover:shadow-[0_3px_0_#6b21a8] transition-all font-['Kalam',cursive] text-lg sm:text-xl flex items-center justify-center gap-2 shrink-0"><Upload className="w-4 h-4 sm:w-5 sm:h-5" /> Share a course</button>
        </div>
        ...
        <section className="bg-purple-100 dark:bg-purple-900/35 border-3 border-purple-300 dark:border-purple-700/60 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-[4px_4px_0_#c084fc] sm:shadow-[6px_6px_0_#c084fc] dark:shadow-[4px_4px_0_#581c87] sm:dark:shadow-[6px_6px_0_#581c87] mb-8 sm:mb-12 relative overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row md:items-center gap-4 sm:gap-5 justify-between">
            <div>
              <h2 className="font-['Kalam',cursive] text-xl sm:text-3xl font-bold text-purple-950 dark:text-purple-100">Have a course to share?</h2>
              <p className="text-purple-800 dark:text-purple-200 font-semibold text-xs sm:text-base mt-1">Select one of your database-backed courses to make it public for other learners.</p>
            </div>
            <button onClick={() => setShowUpload(true)} className="w-full md:w-auto shrink-0 bg-white/80 dark:bg-gray-800/80 text-purple-800 dark:text-purple-200 border-2 border-purple-300 dark:border-purple-600 rounded-xl px-4 py-2.5 sm:px-5 sm:py-3 font-bold text-sm sm:text-base hover:bg-white dark:hover:bg-gray-800 transition-colors flex gap-2 items-center justify-center"><FileUp className="w-4 h-4 sm:w-5 sm:h-5" /> Share course</button>
          </div>
        </section>
        ...
        <div className="flex flex-col md:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
          <label className="relative flex-grow">
            ...
            <input value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Search shared courses..." className="w-full rounded-xl border-2 border-gray-300 dark:border-gray-700 bg-white/85 dark:bg-gray-800/85 py-2.5 sm:py-3 pl-10 sm:pl-12 pr-4 font-bold text-xs sm:text-base text-gray-800 dark:text-gray-100 focus:outline-none focus:border-purple-400 focus:ring-4 focus:ring-purple-200 dark:focus:ring-purple-900/50" />
          </label>
