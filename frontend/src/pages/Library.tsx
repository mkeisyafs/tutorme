  ...
  return (
    <DashboardLayout>
      <div className="max-w-6xl mx-auto md:mx-0 pb-16">
        ...
        {isLoading ? <div className="py-20 grid place-items-center text-purple-700 dark:text-purple-300 font-bold"><LoaderCircle className="w-8 h-8 animate-spin mb-3" />Loading library…</div> : <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-7">{visibleCourses.map((course, index) => {
